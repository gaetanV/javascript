...
(function (global, factory) {
    ...
    strats.data = function (parentVal, childVal, vm) {
        if (!vm) {
            ...
            if (typeof childVal !== 'function') {
                "development" !== 'production' && warn('The "data" option should be a function ' +
    ...
    var Watcher = function Watcher(vm, expOrFn, cb, options) {
        ...
        if (typeof expOrFn === 'function') {
            ...
            if (!this.getter) {
                ...
                "development" !== 'production' && warn("Failed watching path: \"" + expOrFn + "\" " +
    ...
    function initData(vm) {
        ...
        while (i--) {
            if (props && hasOwn(props, keys[i])) {
                "development" !== 'production' && warn("The data property \"" + (keys[i]) + "\" is already declared as a prop. " +
    ...
    function renderSlot(name, fallback, props, bindObject) {
        ...
        if (scopedSlotFn) {
            ...
            if (slotNodes && "development" !== 'production') {
                slotNodes._rendered && warn("Duplicate presence of slot \"" + name + "\" found in the same render tree " +
    ...
    var KeepAlive = {
        ...
        render: function render() {
            ...
            if (componentOptions) {
                ...
                if (name && ((this.include && !matches(this.include, name)) ||
    ...
    function genCheckboxModel(el, value, modifiers) {
        ...
        addHandler(el, CHECKBOX_RADIO_TOKEN, "var $$a=" + value + "," +
            '$$el=$event.target,' +
    ...
    function shouldUpdateValue(elm, vnode, checkVal) {
        return (!elm.composing && (vnode.tag === 'option' ||
    ...
    function setSelected(el, binding, vm) {
        ...
        if (isMultiple && !Array.isArray(value)) {
            "development" !== 'production' && warn("<select multiple v-model=\"" + (binding.expression) + "\"> " +
    ...
    function genFor(el) {
        ...
        if ("development" !== 'production' &&
            ...
            warn$3("<" + (el.tag) + " v-for=\"" + alias + " in " + exp + "\">: component lists rendered with " +
...
System.register("demo/compression/boot", ["src/compression/LZW"], function (exports_2, context_2) {
    "use strict";
            ...
            new Vue({
                ...
                data: {
                    ...
                    compressAction: function (event) {
                        var compress = LZW_1.LZW.compress(this.form.compress);
                    ...
                    uncompressAction: function (event) {
                        ...
                        var uncompress = LZW_1.LZW.uncompress(val);
