...
(function() {
    ...
    function animate() {
        domDiv.delay(2000).css("  background-color ", " blue ").css("position", "absolute");

        domDiv.animate({left:"200"},1000).css( "height ", "50px").animate({width:"800"},1000).css("background-color ", " red ");
