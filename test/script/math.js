    ...
    var test = new testU("MATH.JS");
     ...
     function distance2D(){
        ...
        test.log("DISTANCE");
            ...
            test.log("distance Self: "+v1.distanceTo(v2));
           ...
           var graph = test.graph(); 
            graph.point2D(v1);
             graph.point2D(v3);
            graph.ligne2D(v1,v3);
            test.log("distance Self: "+v1.distanceTo(v3));
      ...
      function distance3D(){
        test.log("<br/>DISTANCE 3D");
            ...
            test.log("distance Self: "+V1.distanceTo(v0));
            test.log("distance Math: "+Math.point.distance(V1,V2));
        ...
        function rotation3D(){
              test.log("<br/>ROTATION 3D");
               ...
               test.log(Math.point.rotation(v1,v0,90,"xz"));
        };
              ...
              test.log("<br/>NORMALIZE");
               ...
               var vector3=new vector();
                ...
                vector4= vector2.normalize();
                 ...
                 test.log("produit scalaire:"+vector4.produitScalaire(vector3));
